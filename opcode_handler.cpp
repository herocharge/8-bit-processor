...
Opcode_handler::Opcode_handler(){
    ...
    std::vector<word_t> single_param_opcodes = {
        0x3A, 0x3E, 0x06, 0x0E, 0x16, 0x1E, 0x26, 0x2E, 0x36, 0xC6, 0xD6, 0xDE, 0xE6, 0xEE, 0xF6, 0xFE
    };
    std::vector<word_t> double_param_opcodes = {
        0x01, 0x11, 0x21, 0x31, 0xC3, 0xC2, 0xCA, 0xD2, 0xDA, 0xE2, 0xEA, 0xF2, 0xFA, 0XCD, 0xC4, 0xCC, 0xD4, 0xDC,  0x32
    };
